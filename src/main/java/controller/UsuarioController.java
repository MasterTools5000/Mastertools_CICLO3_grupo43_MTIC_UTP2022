...
public class UsuarioController implements IUsuarioController {
    ...
    public String verCopias(String username) {
        ...
        try {
            ...
            devolverHerramientas(username, copias);
    ...
    @Override
    public String devolverHerramientas(String username, Map<Integer, Integer> copias) {

        DBConnection con = new DBConnection();

        try {
            for (Map.Entry<Integer, Integer> herramienta : copias.entrySet()) {
                int id = herramienta.getKey();
                int num_copias = herramienta.getValue();

                String sql = "Update herramienta set copias = (Select copias + " + num_copias
